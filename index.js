...
console.log(createMenuItem('French Toast', 11, 'Breakfast'));
console.log(createMenuItem('Eggs and Toast', 8, 'Breakfast'));
console.log(createMenuItem('Spaghetti', 12, 'Dinner'));
...
const burger = {
  ...
  price: 18, 
  category: "Lunch", 
  discount: function(whoGetsDiscount) {
    if(whoGetsDiscount === 'teacher' || whoGetsDiscount === 'student') {
      return this.price - (this.price * 0.25);
    } else if(whoGetsDiscount === 'public') {
...
console.log(addReview(reviews, 'Daniela', 'Beautiful atmosphere and wonderful vegan options!'));
